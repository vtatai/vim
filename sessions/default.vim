...
" Created by session.vim on 03 October 2010 at 11:05:42.
...
badd +90 app/views/layouts/application.html.erb
args [BufExplorer]
...
exe 'vert 1resize ' . ((&columns * 49 + 134) / 269)
exe 'vert 2resize ' . ((&columns * 110 + 134) / 269)
exe '3resize ' . ((&lines * 38 + 39) / 79)
exe 'vert 3resize ' . ((&columns * 108 + 134) / 269)
exe '4resize ' . ((&lines * 38 + 39) / 79)
exe 'vert 4resize ' . ((&columns * 108 + 134) / 269)
argglobal
enew
file NERD_tree_1
setlocal fdm=manual
...
setlocal fen
silent! normal! zE
let s:l = 90 - ((72 * winheight(0) + 38) / 77)
